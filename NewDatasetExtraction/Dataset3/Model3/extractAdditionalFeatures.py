    ...
    with open('../dataset_phishing.csv', mode='r') as file:
        ...
        for line in list_of_lines:
            ...
            if index == 1:
                ...
                if label == "legitimate":
                    benign_list_additional_features.append(extract_additional_features(url, 0, False))
                elif label == "phishing":
                    phishing_list_additional_features.append(extract_additional_features(url, 1, False))
