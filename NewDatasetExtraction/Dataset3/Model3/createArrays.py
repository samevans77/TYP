...
# open all files
# Phishing
with open("phishing_subdomain.txt", 'r') as phishing_subdomain:
    phishing_subdomain_list_of_lines = phishing_subdomain.readlines()

with open("phishing_subdirectory.txt", 'r') as phishing_subdirectory:
    phishing_subdirectory_list_of_lines = phishing_subdirectory.readlines()

with open("phishing_second_level_domain.txt", 'r') as phishing_second_level_domain:
    phishing_second_level_domain_list_of_lines = phishing_second_level_domain.readlines()

with open("phishing_top_level_domain.txt", 'r') as phishing_top_level_domain:
    phishing_top_level_domain_list_of_lines = phishing_top_level_domain.readlines()

# Benign
with open("benign_subdomain.txt", 'r') as benign_subdomain:
    benign_subdomain_list_of_lines = benign_subdomain.readlines()

with open("benign_subdirectory.txt", 'r') as benign_subdirectory:
    benign_subdirectory_list_of_lines = benign_subdirectory.readlines()

with open("benign_second_level_domain.txt", 'r') as benign_second_level_domain:
    benign_second_level_domain_list_of_lines = benign_second_level_domain.readlines()

with open("benign_top_level_domain.txt", 'r') as benign_top_level_domain:
