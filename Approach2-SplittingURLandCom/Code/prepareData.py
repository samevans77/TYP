...
from createArrays import create_subdomain_array, create_second_level_array, create_top_level_array, \
    create_subdirectory_array


def shuffle_data(array1, array2, array3, array4):
    perm = np.random.permutation(len(array3))  # assuming that all arrays are the same size (they are in this case)

    return array1[perm], array2[perm], array3[perm], array4[perm]
...
def prepare_data():
    ...
    subdomain, second_level, top_level, subdirectory = shuffle_data(subdomain_array, second_level_array, top_level_array
                                                                    , subdirectory_array)
    ...
    return training_subdomain_features, training_subdomain_labels, training_second_level_features, \
        ...
        testing_top_level_features, testing_top_level_labels, testing_subdirectory_features, testing_subdirectory_labels
